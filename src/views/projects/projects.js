      ...
      <Box pt={{ base: "20px", md: "40px", xl: "40px" }}>
        ...
        >
          <ProjectCard
            ...
            projectLink="https://github.com/Rampal/NFT-Based-E-Commerce-Website"
          />
          <ProjectCard
            projectImage={collab}
            ...
            projectLink="https://github.com/Rampal/Lets_Collab"
          />
          <ProjectCard
            projectImage={medhub}
            ...
            projectLink="https://github.com/Rampal/MedHub_360"
          />
          <ProjectCard
            projectImage={blog}
            ...
            projectLink="https://github.com/Rampal/Bloggers-Arena"
          />
          <ProjectCard
            projectImage={eeg}
            ...
            projectLink="https://github.com/Rampal/Emotion-Recognition-from-Psychological-Signals"
          />
          <ProjectCard
            projectImage={mtrans}
        ...
        >
          <ProjectCard
            ...
            projectLink="https://rampal.medium.com/steganography-6c9af950cbb3"
          />
          <ProjectCard
            projectImage={steg}
            projectName={"Steganography Blog Part 2"}
            aboutProject={"This Blog is about hiding an Image inside an Image"}
            projectLink="https://rampal.medium.com/steganography-part-2-ad7452a3ff1"
          />
        </SimpleGrid>
      </Box>
    </Box>
